...
def createCard ():
    ...
    for letter in ["B", "I", "N", "G", "O"]:
        ...
        # Update the range of values the will be generated for the
        # next letter
...
# @param card card the bingo card to display
# @return (None)
